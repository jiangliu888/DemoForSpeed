...
class Scheduler:
    ...
    def staticics(self,time_val):
        ...
        cpu_row = ['cpu']
        disk_row = ['disk']
        network_row.append(time_val['network_time'][0])
        cpu_row.append(time_val['cpu_time'][0])
        disk_row.append(time_val['disk_time'][0])
...
if __name__ == "__main__":
    ...
    scheduler.staticics(time_statictics)
