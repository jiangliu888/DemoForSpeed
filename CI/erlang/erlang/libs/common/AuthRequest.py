...
class AuthRequest(object):
    ...
    def post(cls, path, funName, otherParam="", data='{}'):
        ...
        print Template.AUTH_HOST + Template.AUTH_PORT + path + param
        return HttpUtil.post("{}{}{}{}".format(Template.AUTH_HOST, Template.AUTH_PORT, path, param), data, Template.AUTH_HEADERS)
